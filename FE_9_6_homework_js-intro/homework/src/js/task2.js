let firstSide = prompt('Please, input first side of the triangle','0');
let secondSide = prompt('Please, input second side of the triangle','0');
let angle = prompt('Please, input angle between sides of the triangle','0');
const MAX_ANGLE = 179;
